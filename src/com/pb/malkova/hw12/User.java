...
public class User {
    ...
    public static Comparator<User> COMPARE_BY_ADDRESS = (one, other) -> one.getAddress().compareTo(other.getAddress());

    public static Comparator<User> COMPARE_BY_NAME = (one, other) -> one.getName().compareTo(other.getAddress());
    ...
    public static void showAll() {
        ...
        phoneBook.stream().forEach(User -> System.out.println(User));
    }
